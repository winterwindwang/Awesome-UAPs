...
def get_data(dataset, pretrained_dataset, nb_images=2000):
    ...
    if dataset == 'cifar10':
        ...
        traindir = os.path.join(IMAGENET_PATH, 'ImageNet10k')
        ...
        valdir = os.path.join("/mnt/jfs/wangdonghua/dataset/ImageNet/", 'val')
