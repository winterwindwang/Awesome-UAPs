...
from utils.training_cosine import train, save_checkpoint, metrics_evaluate
...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Trains a Cosine-UAP')
    # pretrained
    ...
    parser.add_argument('--pretrained_arch', default='vgg16', choices=['vgg16_cifar', 'vgg19_cifar', 'resnet20', 'resnet56',
                                                ...
                                                'inception_v3','densenet121','densenet161',"resnext50",
                                                "efficientnetb0", "wideresnet", "mnasnet10","mlp", "vit_tiny"],
    ...
    parser.add_argument('--postfix', default='Cosine_UAP_202306_sample_numer',
                        help='Postfix to attach to result folder')
    # Optimization options
    parser.add_argument('--loss_function', default='cos', choices=['ce', 'neg_ce', 'logit', 'bounded_logit',
                                                                  'bounded_logit_fixed_ref', 'bounded_logit_neg', 'cos'],
...
def main():
    ...
    result_path = get_result_path(dataset_name=args.dataset,
                                ...
                                postfix=f"{args.postfix}_{nb_images}")
    ...
    if nb_images < 50000:
        np.random.seed(0)
        sample_indices = np.random.permutation(data_train.__len__())[:nb_images]
        train_data = Subset(data_train, sample_indices)
    ...
    if args.pretrained_dataset != "imagenet":
        ...
        network_data = torch.load(r'F:\PythonPro\training_template_for_AI_challenger_sea8\resnet18.pth.tar')
    ...
    fooling_ratio = metrics_evaluate(data_loader=pretrained_data_test_loader,
    ...
    if fooling_ratio > 80:
        ...
        }, result_path, f'checkpoint_{fooling_ratio}.pth.tar')
