...
def parse_arguments():
    ...
    parser.add_argument('--nb_images', type=int, default=2000,
                        help='Number of iteration_images (default: 2000)')
    parser.add_argument('--result_subfolder', default='default', type=str,
                        help='result subfolder name')
    parser.add_argument('--postfix', default='Revised_sample_numer',
...
def main():
    ...
    # performance of the negative loss is the best
